...
▒   ▒███  ▒  ▒███████    ██████  ▒███    ▒███  ██████   ████████   ▒███ █████   
    ...
    █████    ████ █████▒▒██████  ███████████ ▒▒████████ ████ █████ ████ █████   
   ▒▒▒▒▒    ▒▒▒▒ ▒▒▒▒▒  ▒▒▒▒▒▒  ▒▒▒▒▒▒▒▒▒▒▒   ▒▒▒▒▒▒▒▒ ▒▒▒▒ ▒▒▒▒▒ ▒▒▒▒ ▒▒▒▒▒    
Developer & Author: Christian Emanuel Wijaya
...
os.system('cls||clear')
print('''TheBank [Version '''+version+'''] - Platform '''+platform+'''   ''')
...
def main_login():
    print(Fore.RESET)
    os.system('cls||clear')
    print('''TheBank-Login [Version '''+version+'''] - Platform '''+platform+'''   ''')
    print(Fore.LIGHTGREEN_EX + title_global + Fore.LIGHTWHITE_EX)
...
def main_core():
    sys.stdout.write("\x1b]2;TheBank\x07")
    sys.stdout.flush()
    input(Fore.LIGHTWHITE_EX + "Press 'ENTER' to start!")
    print(Fore.RESET)
    os.system('cls||clear')
    print('''TheBank-Terminal [Version '''+version+'''] - Platform '''+platform+'''   ''')
    print(Fore.LIGHTGREEN_EX + title_global + Fore.LIGHTWHITE_EX)
    print(" ===================================== TheBank Terminal =====================================")
